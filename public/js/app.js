...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_helpers__ = __webpack_require__(30);
...
window.helpers = new __WEBPACK_IMPORTED_MODULE_0__utilities_helpers__["a" /* default */]();
...
var helpers = function () {
    ...
    _createClass(helpers, [{
        ...
        value: function showNotification(message, type, icon) {
        ...
        key: 'displayErrors',
        value: function displayErrors(response, message) {
            var html = '<ul>';
        ...
        key: 'loadSelect',
        value: function loadSelect(url, val, element, text) {
        ...
        key: 'replaceFormData',
        value: function replaceFormData(data, name, value) {
...
if (window.location.pathname == '/patients/create') {
    var getPatientInformation = function getPatientInformation(patientID) {
        axios.get('/api/loadPatientInformation/' + patientID).then(function (response) {
    ...
    var getOptId = function getOptId(text, element) {
        var id = '';
    ...
    var removeParsleyErrors = function removeParsleyErrors() {
    ...
    $(document).ready(function () {
        ...
        $('#form-patient').on('submit', function (e) {
            ...
            if ($('input[name=patient_type]:checked').val() == 'NEW') {
                ...
                axios.post(window.location.origin + '/patients/createNew', helpers.getFormData(formData)).then(function (response) {
                ...
                //Separate datetime for database...
                var date = $('#date_time').data('DateTimePicker').date()._d;
                _formData.push({ name: 'date', value: moment(date).format('YYYY-MM-DD') });
                _formData.push({ name: 'time', value: moment(date).format('HH:mm:ss') });

                axios.post(window.location.origin + '/patients/createOld', helpers.getFormData(_formData)).then(function (response) {
                    helpers.showNotification('New patient added.', 'success', 'fa fa-check');
                    clearForm();
                    $('#patient_number').val(new Date().getTime());
                }).catch(function (error) {
        ...
        $('#province').on("change", function (e) {
            if ($(this).val()) {
                helpers.loadSelect(window.location.origin + '/api/cities/', $(this).val(), $('#municipality'), 'Municipality');
                $('#barangay').empty().trigger('change');
            }
            $(this).parsley().reset();
        });
...
if (window.location.pathname == '/departments') {
    $(document).ready(function () {
        ...
        $('#form-department').on('submit', function (e) {
            ...
            axios.post('/departments', formData).then(function (response) {
        ...
        $('#modal-department-edit').on('submit', '#form-department-edit', function (e) {
            e.preventDefault();
            var id = $('#department-update').val();
            var data = $("#form-department-edit").serialize();
            axios.put('departments/' + id, data).then(function (response) {
...
if (window.location.pathname == '/users') {
    ...
    $(document).ready(function () {
        ...
        $('#form-user').on('submit', function (e) {
            e.preventDefault();
            axios.post('/users', $(this).serialize()).then(function (response) {
        ...
        $('#modal-user-edit').on('shown.bs.modal', function () {
            axios.get('/api/loadRoleSelect').then(function (response) {
            ...
            axios.get('/api/loadDepartmentSelect').then(function (response) {
        ...
        $('#modal-user-edit').on('submit', '#form-user-edit', function (e) {
            e.preventDefault();
            var id = $('#user-update').val();
            var data = $("#form-user-edit").serialize();
            console.log(data);
            axios.put('users/' + id, data).then(function (response) {
...
$(document).ready(function () {
	...
	$('#modal-appointment-record').on('submit', '#form-soap', function (e) {
		e.preventDefault();
		var id = $('#soap-update').val();
		var data = $("#form-soap").serialize();
		axios.put('soap/' + id, data).then(function (response) {
			helpers.showNotification('Department updated.', 'success', 'fa fa-check');
			$("#modal-department-edit").modal('hide');
			$('#table-department').DataTable().ajax.reload();
		}).catch(function (error) {
	...
	$('#table-all-appointments').DataTable({
		...
		ajax: {
			...
			data: function data(_data) {
				for (var i = 0, len = _data.columns.length; i < len; i++) {
					if (!_data.columns[i].search.value) delete _data.columns[i].search;
					if (_data.columns[i].searchable === true) delete _data.columns[i].searchable;
					if (_data.columns[i].orderable === true) delete _data.columns[i].orderable;
					if (_data.columns[i].data === _data.columns[i].name) delete _data.columns[i].name;
				}
				delete _data.search.regex;
			}
		},
		columns: [{ name: "patients.id", data: "patient_id", title: "Patient No.", orderable: true, searchable: true }, { name: "patient_name", data: "patient_name", title: "Patient Name", orderable: true, searchable: true }, { name: "appointments.date", data: "date", title: "Date", orderable: true, searchable: true }, { name: "appointments.time", data: "time", title: "Time", orderable: true, searchable: true }, { name: "appointments.status", data: "status", title: "Status", orderable: true, searchable: true }, { defaultContent: "", data: "action", name: "action", title: "Action", render: null, orderable: false, searchable: false }],
		paging: true,
		info: true,
		responsive: true,
		oLanguage: {
